...
import {
  LayoutGrid, Calendar, Target, Settings, Monitor, UploadCloud, Users, CheckSquare, CalendarPlus, Radar, FileText, BadgeDollarSign, ShieldCheck, Smartphone
} from 'lucide-react'
...
const TABS: { id: Tab; icon: React.ReactNode; label: string; mobile?: boolean }[] = [
  ...
  { id: 'protect',  icon: <ShieldCheck size={18} />, label: 'Protect' },
  { id: 'devices',  icon: <Smartphone size={18} />, label: 'Demos' },
  { id: 'goals',    icon: <Target size={18} />,      label: 'Goals' },
  { id: 'commission', icon: <BadgeDollarSign size={18} />, label: 'Commissions' },
