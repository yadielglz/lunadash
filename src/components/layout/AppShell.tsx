...
const NAV_ITEMS: { id: Tab; icon: React.ReactNode; label: string; helper: string; group: NavGroup }[] = [
  ...
  { id: 'mrc-calculator', icon: <Calculator size={18} />, label: 'MRC Calculator', helper: 'Voice plan pricing', group: 'Performance' },
  { id: 'nr-tracking', icon: <BadgeDollarSign size={18} />, label: 'Sales Tracker', helper: 'Build and publish sales', group: 'Performance' },
