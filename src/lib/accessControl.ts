...
const ROLE_TABS: Record<AccessRole, Tab[]> = {
  admin: ['home', 'district', 'employees', 'schedule', 'appointments', 'tasks', 'goals', 'commission', 'updates', 'settings', 'devices', 'display'],
  district_manager: ['home', 'district', 'employees', 'schedule', 'appointments', 'tasks', 'goals', 'commission', 'updates', 'settings', 'display'],
  manager: ['home', 'district', 'employees', 'schedule', 'appointments', 'tasks', 'goals', 'commission', 'updates', 'settings', 'display'],
  employee: ['home', 'district', 'schedule', 'appointments', 'tasks', 'goals', 'commission', 'settings', 'display'],
  display: ['display'],
}
